...
class SearchClient:
    ...
    def parse_level(server_messages) -> 'State':
        ...
        # Read domain.
        server_messages.readline() # read '#domain'
        server_messages.readline() # read 'hospital'
        
        # Read Level name.
        server_messages.readline() # read '#levelname'
        server_messages.readline() # read '<name>'
        
        # Read colors.
        server_messages.readline() # read '#colors'
